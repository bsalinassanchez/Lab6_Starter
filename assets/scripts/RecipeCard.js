...
class RecipeCard extends HTMLElement {
	...
	set data(data) {
		...
		const org = article.appendChild(document.createElement("p"));
		...
		const star = div.appendChild(document.createElement("span"));
		star.textContent = data.rating;
		const starImg = div.appendChild(document.createElement("img"));
		starImg.setAttribute("src", "/assets/images/icons/" + data.rating + "-star.svg");
		starImg.setAttribute("alt", data.rating + " stars");
		const numRatings = div.appendChild(document.createElement("span"));
		numRatings.textContent = "(" + data.numRatings + ")";

		const time = article.appendChild(document.createElement("title"));
